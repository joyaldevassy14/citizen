	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="displayspec.php" class="nav-link">BOOKING</a></li>
	          <li class="nav-item"><a href="viewbooking.php" class="nav-link">CANCELATION</a></li>
	          <li class="nav-item"><a href="viewhistory.php" class="nav-link">PATIENT HISTORY</a></li>
	           <li class="nav-item"><a href="cancelview.php" class="nav-link">CANCEL DEATAILS</a></li>
