...
<html lang="en">
  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="viewspecilization.php" class="nav-link">specalizations</a></li>
      ...
      <div class="slider-item" style="background-image: url('images/slider3.jpg');">
        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
             <div class="col-md-7">
              <h1 class=" wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInLeft; ">Lorem Ipsum is simply dummy text</h1>
              <p class=" wow   fadeInLeft animated" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInLeft;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the  simply dummy</p>
    ...
    <section class="ftco-section ftco-services">
      <div class="container">
      	<div class="row ">
          <div class="col-md-12 heading-section ftco-animate"  ftco-animate">
                <h2 class="mb-7"><center>ABOUT US</center></h2>
        	...
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					...
      					<div class="text">
	        				<p>Join our digital mailing list and get news deals and be first to know about events</p>
        	...
        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">
        		<div class="staff">
      				...
      				<div class="info text-center">
      					...
      					<span class="position">Dentist</span>
      					<div class="text">
	        				<p>Join our digital mailing list and get news
    ...
    <footer class="ftco-footer ftco-bg-dark ftco-section">
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-3">
            <div class="ftco-footer-widget mb-4">
            	<center><h2 class="ftco-heading-2">Office</h2>
            	<div class="block-23 mb-3">
	              <ul>
	                <center><li><span class="icon icon-map-marker"></span><span class="text">203 Fake St. Mountain View, San Francisco, California, USA</span></li></center>
