...
<body>
    ...
    $rules = array(
        ...
        "phone" => array("required" => true, "integeronly" => true, "minlength" => 10, "maxlength" => 10, "unique" => array("field" => "phone", "table" => "registration")),
    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    <h2 class="title">Registration For New Users</h2>
                    <form method="POST">
